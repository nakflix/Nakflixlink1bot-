...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://kidderke8:alpha3720@nakflixlink1bot.ddf89zy.mongodb.net/?retryWrites=true&w=majority")
...
#Force sub message 
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "Hello {first}\n<b>You Need to be a member of @NAKFLIXTV to use me.\nKindly join @NAKFLIXTV With the Button Below First 👇 </b>")
...
USER_REPLY_TEXT = "❌Don't send me messages directly I'm only File Share bot Contact @nakflixtv!"
